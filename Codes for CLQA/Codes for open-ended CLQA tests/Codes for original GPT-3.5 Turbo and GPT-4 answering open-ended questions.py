...
output_file = "answers_from_openai_multi_models_without_knowledge.xlsx"
header_written = False

if not os.path.exists(output_file):
    pd.DataFrame(columns=["Question", "Requirement", "Answer1", "Answer2", "Answer3"]).to_excel(output_file, index=False)
    header_written = True
...
for i in range(len(questions)):
    ...
    # Combine the question and requirement into a prompt (excluding the "提示" column)
