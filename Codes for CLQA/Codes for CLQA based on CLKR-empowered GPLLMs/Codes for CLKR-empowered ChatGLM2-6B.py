# Modify LLM_MODEL = "chatglm2-6b" in model_config.py
#"chatglm2-6b": {
#    "name": "chatglm2-6b",
    ...
    for year in years:
        ...
        for i in range(len(Questions)):
            ...
            print("No Question", i + 1, "\n", "Right_Answer:", Answers[i],
                  "\nAnswer_from_CLKR-empowered_ChatGLM2-6B:", str(answer).strip().replace("\n", ""))
            df = pd.concat([df, df2], axis=0)
        save_df_to_excel(df, "All_answers_from_CLKR-empowered_ChatGLM2-6B" + year + ".xlsx", "sheet1")
